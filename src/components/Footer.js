          ...
          <div className="media-links">
            <div className="col-sm-1 col-md-1 col-sm-offset-4 col-md-offset-4">
              <div className="facebook">
                <a href="/#">
                  <img alt="" className="img-responsive" src={facebook} />
                </a>
              </div>
            </div>
            ...
            <div className="col-sm-1 col-md-1">
              <div className="linkedin">
                <a href="/#">
                  <img alt="" className="img-responsive" src={linkedin} />
                </a>
              </div>
            </div>
            ...
            <div className="col-sm-1 col-md-1">
              <div className="pinterest">
                <a href="/#">
                  <img alt="" className="img-responsive" src={pinterest} />
                </a>
              </div>
            </div>
            ...
            <div className="col-sm-1 col-md-1">
              <div className="email-icon">
                <a href="/#">
                  <img alt="" className="img-responsive" src={email} />
                </a>
              </div>
            </div>
          </div>
